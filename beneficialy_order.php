        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='?action=work&id=".$row['id']."'>make action</a></td>";
                    echo "<td><a href='update_beneficiry.html'><button>update</button></a>";
                    echo "</td>";
        echo "</tr>";
                }
            } else {
        ...
        <div class="centered">
            ...
            <form>
                <ul>
                    ...
                    <il> <a href="facebook" style="text-decoration: none;"> <img src="facebook.png" alt="facebook"
                                style="height: 40px; width: 40px;"></a></il></br>
                    <il><a href="tweeter" style="text-decoration: none;"> <img src="twitter.png" alt="twitter"
                                style="height: 40px; width: 40px;"> </a></il></br>
