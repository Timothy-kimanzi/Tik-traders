...
<body style="text-align: center; background-color:gray">
    ...
    <h id="h1" style="font-weight: bold;color: black; font-size: 30px;">pay your penalties</h>
    <p>
    <p style="color:blue">Fill the form bellow to pay</p>
    <form action="paypenalty.php" method="post">
        <label for="email">Enter your email</label><br>
        <input type="email" id="email" name="email" required
            style="width: 500px;background-color: cornsilk;color: blue;"><br>
        <label for="password">Enter Transaction code</label><br>
        ...
        <label for="confirm" style="color:black;">confirm data feed is
            correct</label></br>
        <input type="submit" value="apply" style="background-color: blue;">
