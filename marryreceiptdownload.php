...
function generatePDF($id, $conn) {
    ...
    $sql = "SELECT * FROM marry_receipt WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $content = '<h1 style="background-color: #c3e6cb; color: black; padding: 8px;"><img src="trade.png"> Tik Traders marry go round Receipt</h1>';
        ...
        $content .= '<tr><td style="border: 1px solid black; padding: 8px;">Phone number:</td><td style="border: 1px solid black; padding: 8px;">' . $row["phone_number"] . '</td></tr>';
        $content .= '<tr><td style="border: 1px solid black; padding: 8px;">Transaction code:</td><td style="border: 1px solid black; padding: 8px;">' . $row["code"] . '</td></tr>';
...
$sql = "SELECT * FROM marry_receipt WHERE email='$email'";
...
<body style="text-align: center;background-color:gray;">
    ...
    <div class="table-container">
        <h2 style="padding-left:25.5%;">My Payments</h2>
        <table>
            <tr>
                <th>Email</th>
                <th>Phone number</th>
