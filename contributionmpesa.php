...
<head>
    ...
    <title>Marry go round contribution</title>
    ...
    <div class="container d-flex justify-content-center">
        <div class="card mt-5 px-3 py-4">
            ...
            <div class="media mt-3 pl-2">
                ...
                <form class="row g-3" action="./contribution_mpesa.php" method="POST">
                    ...
                    <div class="col-12">
                        ...
                        <input type="number" class="form-control" name="phone" placeholder="eg 254716140575">
                    </div>

                    <div class="col-12">
                        <button type="submit" class="btn btn-success" name="submit" value="submit">Send</button>
                        <button type="reset" class="btn btn-success" name="reset" value="submit">Cancel</button>
                        <button class="btn btn-success "><a href="traders.html"
                                style="color:white;text-decoration:none;">Go Back</></a></button>
                    </div>
                </form>
                <!--bs5 input-->
            </div>
