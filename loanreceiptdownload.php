...
function generatePDF($id, $conn) {
    ...
    if ($result->num_rows > 0) {
        ...
        $content = '<h1 style="background-color: #c3e6cb; color: black; padding: 8px;"><img src="trade.png"> Tik Traders loans Receipt</h1>';
        ...
        $content .= '<tr><td style="border: 1px solid black; padding: 8px;">Amount:</td><td style="border: 1px solid black; padding: 8px;">' . $row["payment"] . '</td></tr>';
        $content .= '</table>';
