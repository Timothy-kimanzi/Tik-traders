...
function generatePDF($id, $conn) {
    ...
    $sql = "SELECT * FROM save_payment WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $content = '<h1 style="background-color: #c3e6cb; color: black; padding: 8px;"><img src="trade.png"> Tik Traders Saving Receipt</h1>';
        ...
        $content .= '<tr><td style="border: 1px solid black; padding: 8px;">Phone number:</td><td style="border: 1px solid black; padding: 8px;">' . $row["phone"] . '</td></tr>';
        $content .= '<tr><td style="border: 1px solid black; padding: 8px;">Transaction code:</td><td style="border: 1px solid black; padding: 8px;">' . $row["transaction"] . '</td></tr>';
...
$sql = "SELECT * FROM save_payment WHERE email='$email'";
...
<body style="text-align: center;background-color:gray;">
    ...
    <p id="p2">
    <div id="d2" class="centered" style="background-color:white;">
        <div class="left">
    ...
    <div id="d2" class="" style="background-color:white;">
        <div class="left">
    ...
    <div id="d3" class="right" style="background-color:white;">
        <div class="centered">
