...
if (isset($_POST['email']) &&  isset($_POST['password'])) {
    ...
    if ($result->num_rows == 1) {
        ...
        $sql_total = "SELECT amount FROM loans WHERE email = ? AND `password` = ?";
        ...
        echo "Invalid username or password. Please try again.<br><button><a href='balances.html'>TRY AGAIN</a></button>";
        exit();
    }
