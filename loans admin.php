...
include('includes/loannavbar.php'); 
?>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">LOANS Admin</h1>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Members with
                                Loans
                            </div>
    ...
    $conn = new mysqli($host, $dbusername, $dbpassword, $dbname);
        ...
        $sql = "SELECT COUNT(*) AS total_members FROM loans";
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Loans
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?PHP $host = "localhost";
                                    $dbusername = "root";
                        ...
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    ...
                                    // Query to get the total amount of money
                                    $sql = "SELECT SUM(payment) AS total_amount FROM payments";
                                    $result = $conn->query($sql);
